...
called Quasi-Monte Carlo. Instead of taking $N$ \textbf{independent} random points $\{x_j\}_{j=1}^N$ 
...
By choosing a good correlation, we hope to reduce the variance of our estimator and 
thus the error of our estimate. 

\par One of the known ways to generate a good correlation is to use a stratified sample, 
