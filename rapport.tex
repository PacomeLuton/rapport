...
In this work, we tried to find new way of finding good sampling function, that are especially
designed for correlated samples. We didn't manage to make a significant improvement, but their
is encouraging result, as it seems to be as good as the actual state of the art. To summarize,
it was a really fun internship, in which I learned a lot on neural network and on adaptative
sampling.

\paragraph*{Acknowledgements} I gratefully acknowledge support from the 
CNRS/IN2P3 Computing Center (Lyon - France) for providing computing and 
data-processing resources needed for this work. We also would like to thank 
Benedikt Bitterli for the tungsten renderer and the scenes used in this paper.
