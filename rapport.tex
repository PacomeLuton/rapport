...
And as we are using sample in high dimension, we don't want to compute integral on each of 
those subdomain where the next sample can be. Thus we can't know the true expectation of $\E_h[\R(X,h | s)]$.
